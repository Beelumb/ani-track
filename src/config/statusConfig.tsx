...
export interface StatusConfigItem {
  ...
  color: string;
  bgColor: string;
  borderColor: string; // Renamed from 'className' to be more specific
  icon: React.ReactNode;
}

// 1. The Definitions (Colors & Icons)
export const statusConfig: Record<string, StatusConfigItem> = {
  plan_to_watch: {
    ...
    icon: (
      <svg width="16" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
  ...
  watching: {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="size-3.5!">
...
// 2. The Order List (Used by Dropdowns to map through)
