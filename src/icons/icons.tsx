...
export const SeasonIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-sun-snow size-4"
  >
...
// FIXED: Changed { } to ( ) for implicit return
export const StatusIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-circle-dashed size-4"
  >
...
export const HashtagIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-hash size-4"
  >
...
export const RatingIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-shield-ellipsis size-4"
  >
...
export const GenresIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-drama size-4"
  >
...
export const SortByIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-arrow-down-wide-narrow size-4"
  >
...
export const StudioIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-building2 size-4"
  >
